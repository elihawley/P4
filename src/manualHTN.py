...
def craft_wooden_axe_and_get_wood (state, ID):
	return [('produce', ID, 'wooden_axe'), ('produce_wood', ID)]

# your code here
pyhop.declare_methods ('produce_wood', wooden_axe_for_wood, craft_wooden_axe_and_get_wood, punch_for_wood)
